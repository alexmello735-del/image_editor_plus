...
class _ImageEditorDrawingState extends State<ImageEditorDrawing> {
  ...
  late BoxConstraints sizeConstraints;
  @override
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                final screenSize = sizeConstraints;
                final imageAspectRatio = widget.image.width / widget.image.height;
                final screenAspectRatio = screenSize.maxWidth / screenSize.maxHeight;
                double displayWidth, displayHeight;

                if (imageAspectRatio > screenAspectRatio) {
                  displayWidth = screenSize.maxWidth;
                  displayHeight = screenSize.maxWidth / imageAspectRatio;
                } else {
                  displayHeight = screenSize.maxHeight;
                  displayWidth = screenSize.maxHeight * imageAspectRatio;
                }
                final pixelRatioX = widget.image.width / displayWidth;
                final pixelRatioY = widget.image.height / displayHeight;

                final optimalPixelRatio = math.max(pixelRatioX, pixelRatioY);
